...
import com.sensei374121.amey.hw4_ameypatil.MovieData;
import com.sensei374121.amey.hw4_ameypatil.R;
 ...
 */
public class Fragment_moviedata extends Fragment {

    //Initializing the movie data object.
    MovieData moviedata_obj= new MovieData();
    static HashMap<String, ?>  movie;

    public Fragment_moviedata(){

    }
    public static Fragment_moviedata newInstance(HashMap<String, ?> inputmovie){
        Fragment_moviedata obj = new Fragment_moviedata();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_moviedata,container,false);
